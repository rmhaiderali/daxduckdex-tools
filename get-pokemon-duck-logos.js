...
// Array.from(
//   new Set(
//     Array.from(document.querySelector("tbody").children).map(
//       (e) => e.children[1].children[0].innerText
//     )
//   )
// )
...
for (const pokemon of pokemons) {
  console.log("Fetching page for Pokemon:", pc.yellow(pokemon))

  const response = await fetch(
    "https://duckduckgo.com/?q=" + encodeURIComponent(pokemon)
  )
...
if (logos.length) {
  ...
  console.log(logos.map((logo) => "https://duckduckgo.com" + logo))
} else {
